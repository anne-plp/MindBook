...
public class CopyOfCalendarAdapter extends BaseAdapter {
...
private Context mContext;
    ...
    public CopyOfCalendarAdapter(Context c, Calendar monthCalendar) {
     month = monthCalendar;
     ...
     TextView dayView;
        if (convertView == null) { // if it's not recycled, initialize some attributes
         LayoutInflater vi = (LayoutInflater)mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            v = vi.inflate(R.layout.calendaritem, null);
